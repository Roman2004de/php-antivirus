...
?>
<p>
    <a class="adm-btn" href="/bitrix/admin/delement_antivirus_results.php?lang=<?php echo LANGUAGE_ID; ?>">
        <?php echo Loc::getMessage('DELEMENT_ANTIVIRUS_RESULTS_BACK_TO_LIST'); ?>
    </a>
</p>
<?php
