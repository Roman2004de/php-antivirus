...
Начать с проектирования пользовательской/тестовой базы hash-индикаторов без копирования сторонних malware hash databases.
